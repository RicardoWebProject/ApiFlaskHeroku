...
class Confirmation(Resource):
    ...
    def get(cls, confirmation_id: str):
        """Retorna la página HTML de confirmación"""
...
class ConfirmationByUser(Resource):
    ...
    def get(cls, user_id: int):
        """Retorna la confirmación para un usuario. Usado para testing"""
    ...
    def post(cls, user_id: int):
        ...
        try:
            ...
            return {'message': gettext("confirmation_resend_succesful")}, 201
